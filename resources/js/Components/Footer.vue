...
<template>
    <footer 
        class="fixed bottom-0 right-0 h-9 bg-[#0a0b0d] flex items-center justify-between px-6 z-50 transition-all duration-300 ease-in-out text-[10px] text-gray-500 font-sans"
    ...
    >
        ...
        <div class="flex items-center gap-6 ml-auto whitespace-nowrap">
            ...
            <div class="flex items-center gap-3 border-l border-[#1f2128] pl-4">
