    ...
    <div class="min-h-screen flex bg-[#0a0b0d] text-gray-300 font-sans selection:bg-[#8c52ff] selection:text-white">
        ...
        <div class="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-20 xl:px-24 w-full lg:w-[40%] relative z-20 bg-[#0a0b0d]">
            <div class="mx-auto w-full max-w-sm lg:w-96">
                ...
                <div v-if="status" class="mb-6 text-sm font-medium text-green-400 bg-green-400/10 p-4 rounded-lg border border-green-400/20">
                    {{ status }}
                </div>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between pt-2">
                        <label class="flex items-center cursor-pointer group">
                            <Checkbox name="remember" v-model:checked="form.remember" class="bg-[#121317] border-[#2d2f36] text-[#8c52ff] rounded focus:ring-offset-[#0a0b0d] focus:ring-[#8c52ff]" />
                        ...
                        <Link
                            ...
                            class="text-sm font-medium text-gray-500 hover:text-[#8c52ff] transition-colors"
                        >
                            Forgot password?
                        </Link>
                    </div>
                    ...
                    <PrimaryButton
                        class="w-full flex justify-center items-center py-4 px-4 border border-transparent rounded-xl shadow-lg shadow-purple-900/20 text-sm font-bold text-white bg-gradient-to-r from-[#8c52ff] to-[#5ce1e6] hover:opacity-90 hover:scale-[1.01] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#8c52ff] focus:ring-offset-[#0a0b0d] transition-all uppercase tracking-widest"
                ...
                <div class="mt-8 text-center">
                    <p class="text-sm text-gray-600">
                        ...
                        <Link :href="route('register')" class="font-bold text-gray-400 hover:text-white transition-colors">
                            Sign up now
                        </Link>
                    </p>
                </div>
                ...
                <div class="mt-10">
                    ...
                    <div class="mt-6 flex justify-center gap-4">
                        ...
                        <a href="https://discord.com" target="_blank" class="w-12 h-12 flex items-center justify-center rounded-xl bg-[#121317] border border-[#2d2f36] text-gray-400 hover:text-white hover:border-[#5865F2] hover:bg-[#1a1b20] hover:scale-110 transition-all duration-300 group">
